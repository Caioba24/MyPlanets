...
public class MainActivity extends AppCompatActivity {
    ...
    int imagemPlanetas[] = {R.drawable.jupiter, R.drawable.lua, R.drawable.marte, R.drawable.mercurio,
            R.drawable.netuno, R.drawable.plutao, R.drawable.saturno, R.drawable.sol, R.drawable.terra, R.drawable.urano,
            R.drawable.venus};
    ...
    public class MyAdapter extends BaseAdapter {
        ...
        public View getView(int i, View view, ViewGroup viewGroup) {
            //Declarar os componentes do modelo que serão ultilizados na lista
            ...
            txtPlanetas = view1.findViewById(R.id.idtxtPlaneta);
            imgPlanetas = view1.findViewById(R.id.idmodeloPlaneta);
